                        ...
                        <div class="album-intro">
                            ...
                            <?php if ($isSubalbum) { ?>
                                <div class="album-social">
                                    ...
                                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://<?php echo getMainSiteURL() ?><?php echo getAlbumLinkURL(); ?>" data-text="Que lindas las fotos de <?php echo getAlbumTitle(); ?>" data-via="mirumbita" data-lang="es">Twittear</a>
